...
runadaptation = parse(Int,ARGS[4])
...
job = string(startval_σ_ϵ)*"_"*string(runadaptation)*"_"*string(R)*"_"*string(M_subjects)*"_"*string(N_time)*"_"*string(nbr_particles)*"_"*string(ρ)
