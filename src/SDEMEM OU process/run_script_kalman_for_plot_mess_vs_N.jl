...
CSV.write("data/SDEMEM OU/kalman for plot mess vs N/sim_data_"*string(seed_inference)*"_"*job*".csv", DataFrame(sim_data))
CSV.write("data/SDEMEM OU/kalman for plot mess vs N/chain_sigma_epsilon_"*string(seed_inference)*"_"*job*".csv", DataFrame(chain_σ_ϵ_kalman'))
CSV.write("data/SDEMEM OU/kalman for plot mess vs N/chain_eta_"*string(seed_inference)*"_"*job*".csv", DataFrame(chain_η_kalman'))
CSV.write("data/SDEMEM OU/kalman for plot mess vs N/chain_phi_"*string(seed_inference)*"_"*job*".csv", DataFrame(chain_ϕ_export'))
