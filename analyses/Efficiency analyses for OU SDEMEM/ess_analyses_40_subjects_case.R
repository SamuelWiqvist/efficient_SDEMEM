...
load_results <- function(seed) {
  ...
  ess = c(ess_epsilon, ess_eta, ess_phi)
  ess_min_per_min_pmmh_naive = min(ess)/run_time_pmmh_naive
  ...
  ess = c(ess_epsilon, ess_eta, ess_phi)
  ess_min_per_min_pmmh = min(ess)/run_time_pmmh
  ...
  ess = c(ess_epsilon, ess_eta, ess_phi)
  ess_min_per_min_cpmmh099 = min(ess)/run_time_cpmmh099
  ...
  ess = c(ess_epsilon, ess_eta, ess_phi)
  ess_min_per_min_cpmmh0999 = min(ess)/run_time_cpmmh0999
